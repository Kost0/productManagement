...
const (
	OrdersService_GetOrder_FullMethodName    = "/order.OrdersService/GetOrder"
	OrdersService_OrdersList_FullMethodName  = "/order.OrdersService/OrdersList"
	OrdersService_CreateOrder_FullMethodName = "/order.OrdersService/CreateOrder"
)
...
var OrdersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "order.OrdersService",
